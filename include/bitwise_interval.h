            ...
            // high
            {
                ...
                if (flip_x)
                {
                    ...
                    else
                    {
                        ...
                        {
                            // high_x done
                            high_x.low = high_x.high = (mask_x & r) | fixed_x;
                        }
                        else
                        {
                            high |= b;
                ...
                else
                {
                    if (flip_y)
                    {
                        ...
                        {
                            // high_y done
                            high_y.low = high_y.high = (mask_y & r) | fixed_y;
                        }
                        else
                        {
                            high |= b;
            ...
            // high
            {
                ...
                if (flip_x)
                {
                    if (flip_y)
                    {
                        ...
                        high_x.low = fixed_x;
                        high_x.high = fixed_x;
                        high_y.low = (r & m) | fixed_y;
                        high_y.high = (r & m) | fixed_y;
                    }
                    else
                    {
                        high |= b;
